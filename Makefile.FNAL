...
RootLib= -L $(ROOT_INC)/../lib `root-config --libs` -lGenVector -lMinuit -lGeom -lEve #-lGL -lGLU -lGLEW
...
lib/libMyTools.so: UserTools/* UserTools/*/* include/Tool.h lib/libDataModel.so | lib/libToolChain.so
