...
LAPPDStoreBaselineSubtract::LAPPDStoreBaselineSubtract():Tool(){}


bool LAPPDStoreBaselineSubtract::Initialise(std::string configfile, DataModel &data)
{
    /////////////////// Usefull header ///////////////////////
...
bool LAPPDStoreBaselineSubtract::Execute()
{
    bool isBLsub=true;
...
Waveform<double> LAPPDStoreBaselineSubtract::SubtractSine(Waveform<double> iwav) 
{
...
bool LAPPDStoreBaselineSubtract::Finalise()
{
    return true;
}
