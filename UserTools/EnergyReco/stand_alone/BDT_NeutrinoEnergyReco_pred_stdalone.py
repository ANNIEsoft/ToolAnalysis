...
#--- evts for training:
infile = "../LocalFolderD/vars_Ereco.csv"
#--- evts for prediction:
infile2 = "../LocalFolderD/vars_Ereco.csv"
...
filename = '/ToolAnalysis/UserTools/EnergyReco/stand_alone/weights/finalized_BDTmodel_forNeutrinoEnergy.sav'
...
df1 = pd.DataFrame(test_data_trueKE_hi_E,columns=['NeutrinoEnergy (MeV)'])
...
#save results to .csv:  
df_final.to_csv("/ToolAnalysis/outputs_ener/ErecoENEU_results.csv", float_format = '%.3f')
