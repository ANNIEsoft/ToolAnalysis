#include "LAPPDSaveRootWC.h"

LAPPDSaveRootWC::LAPPDSaveRootWC():Tool(){}


bool LAPPDSaveRootWC::Initialise(std::string configfile, DataModel &data){
  ...
  outtree->Branch("Simpletime",&Simpletime);
