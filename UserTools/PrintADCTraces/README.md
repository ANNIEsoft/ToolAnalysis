...
`PrintADCTraces` will read the ADC traces in "RecoADCData", and output the pulses to a root file. It will also filter traces/hits within some range of charges or times provided by the user.
