...
namespace {
  ...
  constexpr long double ln_LDBL_MAX =  1.13565234062941435e+4L;
  constexpr double max_double_arg = 171.0;
  constexpr long double max_long_double_arg = 1755.5L;
}
...
////////////////////////////////////////////////////////////////////////////////
double annie_math::Beta_Function(double a, double b)
{
...
double annie_math::Incomplete_Beta_Function(double x, double a, double b)
{
...
long double xBeta_Function(long double a, long double b)
{
   ...
   if ( (a + b) <= Gamma_Function_Max_Arg() )
      return std::tgamma(a) / (std::tgamma(a + b) / std::tgamma(b));

     // If (a + b) > Gamma_Function_Max_Arg() then simply return //
     //  exp(lngamma(a) + lngamma(b) - lngamma(a+b) ).           //

   lnbeta = std::lgamma(a) + std::lgamma(b) - std::lgamma(a + b);
...
////////////////////////////////////////////////////////////////////////////////
double Gamma_Function_Max_Arg() { return max_double_arg; }
}
