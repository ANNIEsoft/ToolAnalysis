...
LAPPDPSECReadIn::LAPPDPSECReadIn():Tool(){}


bool LAPPDPSECReadIn::Initialise(std::string configfile, DataModel &data){
...
bool LAPPDPSECReadIn::Finalise(){
  DataFile.close();
  return true;
}


bool LAPPDPSECReadIn::ReadPedestals(int boardNo){
...
bool LAPPDPSECReadIn::MakePedestals(){
